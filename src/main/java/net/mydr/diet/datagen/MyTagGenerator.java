...
public class MyTagGenerator extends FabricTagProvider<Item> {
     ...
     */
    public MyTagGenerator(FabricDataGenerator dataGenerator) {//, Registry<Item> registry
    ...
    protected static List<Item> createList(Item... items) {
        return createList(Comparator.comparing(e -> Objects.requireNonNull(e.getDescriptionId())),
                items);
    }
    ...
    protected void generateTags() {
        ...
        for (Item element : elements) {
            getOrCreateTagBuilder(FRUITS).add(element);
        }
        ...
        for (Item element : elements) {
            getOrCreateTagBuilder(GRAINS).add(element);
        }
        getOrCreateTagBuilder(PROTEINS).addTags(ItemTags.FISHES);
        getOrCreateTagBuilder(PROTEINS).addTags(Tags.Items.SLIMEBALLS);
        elements = createList(
                Items.BEEF,
                Items.BONE,
                Items.CHICKEN,
        ...
        for (Item element : elements) {
            getOrCreateTagBuilder(PROTEINS).add(element);
        }
        ...
        for (Item element : elements) {
            getOrCreateTagBuilder(SUGARS).add(element);
        }
        elements = createList(
                Items.BEETROOT,
        ...
        for (Item element : elements) {
            getOrCreateTagBuilder(VEGETABLES).add(element);
        }
        getOrCreateTagBuilder(VEGETABLES).addTags(ItemTags.FLOWERS);
        getOrCreateTagBuilder(VEGETABLES).addTags(ItemTags.LEAVES);
        getOrCreateTagBuilder(VEGETABLES).addTags(Tags.Items.MUSHROOMS);
        ...
        for (String element : optionalElements) {
            getOrCreateTagBuilder(FRUITS).addOptional(new ResourceLocation(element));
        }
        ...
        for (String element : optionalElements) {
            getOrCreateTagBuilder(GRAINS).addOptional(new ResourceLocation(element));
        }
        optionalElements = createList(
        ...
        for (String element : optionalElements) {
            getOrCreateTagBuilder(PROTEINS).addOptional(new ResourceLocation(element));
        }
        optionalElements = createList(
        ...
        for (String element : optionalElements) {
            getOrCreateTagBuilder(SUGARS).addOptional(new ResourceLocation(element));
        }
        optionalElements = createList(
        ...
        for (String element : optionalElements) {
            getOrCreateTagBuilder(VEGETABLES).addOptional(new ResourceLocation(element));
        }
//        getOrCreateTagBuilder(FRUITS)
//                .add(Items.APPLE)
//                .add(Items.GOLDEN_APPLE)
//                .add(Items.ENCHANTED_GOLDEN_APPLE);
//        getOrCreateTagBuilder(GRAINS);
//        getOrCreateTagBuilder(PROTEINS);
//        getOrCreateTagBuilder(SUGARS);
//        getOrCreateTagBuilder(VEGETABLES);
    }
}
